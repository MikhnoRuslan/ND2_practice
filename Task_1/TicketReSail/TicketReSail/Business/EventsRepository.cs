...
namespace TicketReSail.Business
{
    public class EventsRepository
    {
        ...
        private readonly IStringLocalizer<EventsRepository> _localizer;

        public EventsRepository(IStringLocalizer<EventsRepository> localizer)
        {
            _localizer = localizer;

            _categories = new List<Category>
            {
                new Category{Id = 1, Name = _localizer["Film"]},
                new Category{Id = 2, Name = _localizer["Concert"]},
                new Category{Id = 3, Name = _localizer["Party"]},
                new Category{Id = 4, Name = _localizer["Exhibition"]}
            };
            ...
            {
                new Event{Id = 1, Category = _categories[0], Name = _localizer["Home Alone"],
                    Date = new DateTime(2020, 10, 9, 19, 0,0), Venue = _venues[0], Banner = "Home Alone.jpg", Description = "lala"},
                new Event{Id = 2, Category = _categories[0], Name = _localizer["The Silence of the Lambs"],
                ...
                new Event{Id = 10, Category = _categories[3], Name = _localizer["ZooWorld"],
                    Date = new DateTime(2020,10,23), Venue = _venues[9], Banner = "ZooWorld.jpg", Description = "lala"},
                new Event{Id = 11, Category = _categories[3], Name = _localizer["Cat and Autumn"],
                    Date = new DateTime(2020,10,23), Venue = _venues[10], Banner = "CatAndAutumn.jpg", Description = "lala"},
                new Event{Id = 12, Category = _categories[3], Name = _localizer["Motherhood, childhood"],
